    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            >
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">View Offer Course</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="#">View Exam Hall</a>
                </li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mt-3 border-success">
                                <div class="card-body">
                                    <h5 class="card-title ">Your Profie</h5>
                                    <hr />
                                    
                                    <form method="post" action="{{route('updates-profile')}}">
                                        @csrf
